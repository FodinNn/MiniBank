...
function SelectTrigger({
  ...
  return (
    <SelectPrimitive.Trigger
      ...
      className={cn(
        'flex h-10 w-full items-center justify-between gap-2 whitespace-nowrap rounded-xl border border-input bg-background/40 px-3 py-2 text-sm',
        'placeholder:text-muted-foreground/70 focus-visible:border-ring focus-visible:ring-[3px] focus-visible:ring-ring/30 focus-visible:outline-none',
